        ...
        : !_isSupportCanvas()
            ...
            : (function () {
                ...
                Drawing.prototype.draw = function (oQRCode) {
                    ...
                    var nCount = oQRCode.getModuleCount();
                    var nWidth = (_htOption.width - 20) / nCount;
                    var nHeight = (_htOption.height - 20) / nCount;
                    ...
                    _oContext.fillRect(
                        0,
                        0,
                        _oContext.canvas.width,
                        _oContext.canvas.height
                    );
                    for (var row = 0; row < nCount; row++) {
                        for (var col = 0; col < nCount; col++) {
                            var bIsDark = oQRCode.isDark(row, col);
                            var nLeft = col * nWidth + 10;
                            var nTop = row * nHeight + 10;
