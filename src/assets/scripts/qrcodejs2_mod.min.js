...
!(function (root, factory) {
    ...
    (QR8bitByte.prototype = {
        ...
        (QRCodeModel.prototype = {
            ...
            setupTimingPattern: function () {
                for (var r = 8; r < this.moduleCount - 8; r++)
                    null == this.modules[r][6] &&
                        (this.modules[r][6] = r % 2 == 0);
                for (var c = 8; c < this.moduleCount - 8; c++)
                    null == this.modules[6][c] &&
                        (this.modules[6][c] = c % 2 == 0);
            },
            setupPositionAdjustPattern: function () {
                for (
                    var pos = QRUtil.getPatternPosition(this.typeNumber), i = 0;
                    i < pos.length;
                    i++
                )
            ...
            setupTypeNumber: function (test) {
                for (
                    var bits = QRUtil.getBCHTypeNumber(this.typeNumber), i = 0;
                    i < 18;
                    i++
                ) {
                        ...
                        for (var c = 0; c < 2; c++)
                            if (null == this.modules[row][col - c]) {
                                ...
                                byteIndex < data.length &&
                                    ...
                                    QRUtil.getMask(maskPattern, row, col - c) &&
                                        (dark = !dark),
        ...
        (QRCodeModel.createBytes = function (buffer, rsBlocks) {
            ...
            for (var totalCodeCount = 0, i = 0; i < rsBlocks.length; i++)
        ...
        var QRMode = {
            ...
            QRUtil = {
                ...
                getErrorCorrectPolynomial: function (errorCorrectLength) {
                    for (
                        var a = new QRPolynomial([1], 0), i = 0;
    ...
    function _getAndroid() {
        ...
        if (/android/i.test(sAgent)) {
            ...
            aMat && aMat[1] && (android = parseFloat(aMat[1]));
        }
        return android;
    }
            ...
            'svg' === document.documentElement.tagName.toLowerCase()
                ...
                ? (function () {
                      ...
                      function _safeSetDataURI(fSuccess, fFail) {
                          ...
                          !0 === self._bSupportDataURI && self._fSuccess
                              ? self._fSuccess.call(self)
                              : !1 === self._bSupportDataURI &&
                                self._fFail &&
                      ...
                      return (
                          (Drawing.prototype.draw = function (oQRCode) {
                              var _elImage = this._elImage,
                                  ...
                                  nCount = oQRCode.getModuleCount(),
                                  nWidth = (_htOption.width - 20) / nCount,
                                  nHeight = (_htOption.height - 20) / nCount,
                      ...
                      return (
                          (Drawing.prototype.draw = function (oQRCode) {
                              ...
                              var elTable = _el.childNodes[0],
                                  nLeftMarginTable =
                                      (_htOption.width - elTable.offsetWidth) /
                                      2,
                                  nTopMarginTable =
                                      (_htOption.height -
                                          elTable.offsetHeight) /
                                      2;
                              nLeftMarginTable > 0 &&
                                  nTopMarginTable > 0 &&
    ...
    return (
        ((QRCode = function (el, vOption) {
            if (
                ...
                'string' == typeof vOption && (vOption = { text: vOption }),
                vOption)
            )
                for (var i in vOption) this._htOption[i] = vOption[i];
            'string' == typeof el && (el = document.getElementById(el)),
                this._htOption.useSVG && (Drawing = svgDrawer),
                (this._android = _getAndroid()),
                (this._el = el),
                (this._oQRCode = null),
                (this._oDrawing = new Drawing(this._el, this._htOption)),
                this._htOption.text && this.makeCode(this._htOption.text);
        }).prototype.makeCode = function (sText) {
