...
SmartBanner.prototype = {
	...
	create: function () {
		...
		var container = doc.getElementById(this.options.appendTo) || doc.body;
		if (container) {
	...
	hide: function () {
		var container = doc.getElementById(this.options.appendTo) || root;
		container.classList.remove('smartbanner-show');
	...
	show: function () {
		var container = doc.getElementById(this.options.appendTo) || root;
		container.classList.add('smartbanner-show');
